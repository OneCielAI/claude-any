...
The repository includes an npm publish workflow. Add an npm automation token as
the GitHub repository secret `NPM_TOKEN`, then publish a GitHub Release or run
the `Publish to npm` workflow manually.
